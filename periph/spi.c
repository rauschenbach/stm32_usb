...
*/
	...
	GPIO_ResetBits(DISP_SPI_RESET_GPIO_PORT, DISP_SPI_RESET_PIN);	/*  RESET hi - не выбрано */
	delay_ms(50);
	GPIO_SetBits(DISP_SPI_RESET_GPIO_PORT, DISP_SPI_RESET_PIN);	/*  RESET hi - не выбрано */
}
